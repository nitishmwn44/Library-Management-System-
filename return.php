...
if (isset($_POST['submit'])) 
{
	...
	$cat=$_POST['cat'];
	$sql="SELECT * FROM libops WHERE ".$cat." LIKE '%".$searchby."%'";
}
else
{
...
<div class="container text-center" style="">
	<form  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
        ...
        <option value="studname">Username</option>
  ...
  <table class="table">
    ...
    <tbody>
      ...
      echo "<tr>";
        ...
        if($row["returnd"]=='')
        {
          echo "<td><a href='returner.php?x=".$row["id"]."'><div class='tb' style='text-align:center;'>Return</div></td>";
        }
        else
        {
