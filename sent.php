...
if (isset($_POST['submit'])) 
{
	...
	$cat=$_POST['cat'];
	$sql="SELECT * FROM messages WHERE senderun='".$_SESSION['user']."' AND ".$cat." LIKE '%".$searchby."%'";
}
else
{
...
<div class="container text-center" style="">
	<form  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
        ...
        <option value="receiverun">To</option>
	...
	echo "</tr>";
	echo "<tr >";
		echo "<td td colspan='2'style='font-size:20px;'>".$row['message']."</td>";
	echo "</tr>";
	echo "</table>";
	}
include('footer.php');
