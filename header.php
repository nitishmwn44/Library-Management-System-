                ...
                <ul class="list-unstyled components" style="padding-top: 0px;">
                    ...
                    <li>
                        ...
                        <ul class="collapse list-unstyled" id="mprof">
                            ...
                            <li><a href="vprof.php">View Profile</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="#mbooks" data-toggle="collapse" aria-expanded="false">Manage Books</a>
                        <ul class="collapse list-unstyled" id="mbooks">
                            <li><a href="addbook.php">Add Books</a></li>
                            <li><a href="updateb.php">Update Book Stock</a></li>
                    ...
                    <li>
                        <a href="#mtasks" data-toggle="collapse" aria-expanded="false">Library Tasks</a>
                        <ul class="collapse list-unstyled" id="mtasks">
                            <li><a href="issue.php">Issue Books</a></li>
                            <li><a href="return.php">View/Return Issued Books</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="sendmess.php">Send Messages</a>
                    </li>
                    <li>
                    ...
                    <div class="container-fluid text-center">
                        ...
                        <div class="container text-center" style="color: white;font-size: 25px;float: right;padding-top: 12px;width:80px;position:relative;">
                            ...
                            <div id="tools" class="fadein text-center" style="padding: 20px;">
                                <a href="vprof.php"><span class="glyphicon glyphicon-user" id="profi"></span></a>
                                <h3 style="color: #f29818;"><?php echo $_SESSION['user'];  ?></h3>
                                <span class="glyphicon glyphicon-remove" id="closeb" onclick="closet()"></span>
                                <a href="editp.php"><div class="tb">Edit Profile</div></a>
                                <a href="changep.php"><div class="tb">Change Password</div></a>
