...
if (isset($_POST['submit'])) 
{
	...
	$cat=$_POST['cat'];
	$sql="SELECT * FROM messages WHERE receiverun='".$_SESSION['user']."' AND ".$cat." LIKE '%".$searchby."%' AND isread='no'";
}
else
{
	$sql="SELECT * FROM messages WHERE receiverun='".$_SESSION['user']."' AND isread='no'";
}
...
<div class="container text-center" style="">
	...
	echo "</tr>";
	echo "<tr>";
		echo "<td colspan='2'><div style='text-align:center;'><a href='receiver.php?x=".$row["id"]."'><div class='tb container' style='text-align:center;'>Mark as Read</div></a></div></td>";
	echo "</tr>";
	echo "</table>";
	}
include('footers.php');
