  ...
  <div class="main-bg" style="text-align: center;padding-bottom: 50px;">
    ...
    <div class="container text-center dibba" style="background-color:#ebbb38;border-radius: 25px;padding-bottom: 50px;">
      ...
      <div class="row" style="padding: 20px;">
        <a href="studl.php">
        <div class="col-sm-4 text-center tabl inactive slidel">
          Login
        </div>
        </a>
        <a href="studr.php">
        <div class="col-sm-4 text-center tabm inactive fadein">
          Register
        </div>
        </a>
        
        <div class="col-sm-4 text-center tabr  slider">
          Forgot Password
        </div>
      </div>
      <?php
        if($noe===0&&$sub===1)
        {
        $sql="SELECT * FROM students WHERE name='$name' AND roll='$roll' AND email='$email'";
      ...
      <div class="text-center" style="padding-top: 10px;">
        <form  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
          ...
          <input type="text" class="slidel" name="roll" placeholder="Roll No." value="<?php echo htmlspecialchars($roll);?>">
          <br>
          <br>
          <?php if ($error["roll"]!='') { ?>
          <div class="container text-center dibba fadein" style="text-align: center;align-self: center;">
